...
const rentalSchema = new Schema({
    ...
    course60img: String,
    course90img: String,
    course60Description: { type: String, lowercase: true },
    course90Description: { type: String, lowercase: true },
    ...
    image2: { type: String },
    gallery: { type: String },
    gallery2: { type: String },
    gallery3: { type: String },
    gallery4: { type: String },
    gallery5: { type: String },
    video: { type: String },
    province: { type: String, lowercase: true, default: '東京' },
    nearStation: { type: String, lowercase: true },
    hourlyPrice: Number,
