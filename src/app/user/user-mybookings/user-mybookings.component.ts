...
@Component({
  selector: 'app-user-mybookings-dialog',
  templateUrl: './user-mybookings-dialog.html'
})
export class UserMyBookingDialog {
...
export class UserMyBookingsComponent implements OnInit, OnDestroy {
  ...
  openDialog(booking) {
    const dialogRef = this.dialogService.open(UserMyBookingDialog)
